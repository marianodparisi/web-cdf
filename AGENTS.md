...
Antes de modificar este repositorio, leer `PROJECT_MEMORY.md` completo. Ese archivo es la memoria vigente del proyecto y documenta el entorno, la arquitectura, el sistema visual, las restricciones de contenido y el proceso de verificación.
...
- Verificar cambios visuales en desktop y mobile, además de ejecutar el build.
